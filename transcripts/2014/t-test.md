...
**Kyle:** Welcome back to another mini-episode of the data skeptic podcast. I'm here as always with my wife and co-host Linh Da.

**Linh Da:** Hello Hello.

**Kyle:** how are you doing Linh Da?
...
**Linh Da:** It's a Wine Atlas.

**Kyle:** On atlas I'm sorry. And what is the content of the wine atlas?

**Linh Da:** It is all about wine. I'm only on page 30 so I'm not sure what the rest of about I don't know.
...
**Linh Da:** Yep. So I think if you're asking me what it's about you should check back in a month.
...
**Linh Da:** I haven't gotten to that part I think their goal to make the wine taste good which can change depending on the season and the trends so I'm not sure what their goal is.
...
**Linh Da:** Yes it's an upside-down U. Like levels off at both ends like a squid.
...
**Linh Da:** I don't know but my guess is no.
...
**Linh Da:** So long ago but a little but yes.
...
**Linh Da:** No but now that I know they exist that is so nifty

**Kyle:** And you can apply them can't you?

**Linh Da:** No, because I don't know how to apply them. But that's awesome.
...
**Linh Da:** So is the result like a number, percentage, or range? What does it spit out?
...
**Linh Da:** What's an example of a p-value?
...
**Linh Da:** So in your wine example you only gave one example grape A grape B. Is that enough data?
...
**Linh Da:** So you're comparing two means and that's how you enter the data into excel.
...
**Linh Da:** So then you enter all of it into Excel and then Excel automatically find the mean. Then does the t-test, then creates the p-value.

**Kyle:** You got it.

**Linh Da:** You you told me how to do it in Excel. So that makes me 20 times more likely to lean on Excel for this.
...
**Linh Da:** That's interesting because I just read an article that said creating breweries in multiple places and actually creating consistent brews beer in two separate locations is extremely difficult. So no doubt this brewery person probably mastered it.
